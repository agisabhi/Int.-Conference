                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <center><i class="icon-user"></i> <span><?= $namaadmin; ?></span></center>
                                        </li>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="/admin/abstrak" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow" href="/admin/full_paper" aria-expanded="false">
                            <i class="icon-menu menu-icon"></i> <span class="nav-text">Full Paper</span>
                        </a>

                    </li>
                    <li>
                        <a class="has-arrow" href="/admin/payment" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Payment</span>
                        </a>

                    </li>
                    <li>
                        <a class="has-arrow" href="/admin/revised_paper" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Revised Paper</span>
                        </a>

                    </li>
                    <li>
                        <a class="has-arrow" href="/admin/poster" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Poster</span>
                        </a>

                    </li>
                    <li>
                        <a class="has-arrow" href="/admin/sertifikat" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Sertifikat</span>
                        </a>
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">User Data</span>
                        </a>

                    </li>
                    <li class="nav-label">Schedule Management</li>
                    <li>
                        <a class="has-arrow" href="/admin/schedule" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Conference Schedule</span>
                        </a>

                    </li>
                    <li class="nav-label">Announcement</li>
                    <li>
                        <a class="has-arrow" href="/admin/email" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Email</span>
                        </a>

                    </li>
                    <li class="nav-label">PAGE MANAGEMENT</li>
                    <li>
                        <a class="has-arrow" href="/admin/setHome" aria-expanded="false">
                            <i class="icon-grid menu-icon"></i> <span class="nav-text">Home</span>
                    ...
                    <li>
                        ...
                        <i class="icon-grid menu-icon"></i> <span class="nav-text">Speakers</span>
                        </a>
                    </li>
...
<script src="/template/theme/plugins/summernote/dist/summernote.min.js"></script>
    <script src="/template/theme/plugins/summernote/dist/summernote-init.js"></script>
